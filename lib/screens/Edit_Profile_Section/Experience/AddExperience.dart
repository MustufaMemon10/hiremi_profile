              ...
              children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextField(controller: organizationController, hintText: 'eg: Google')
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextField(controller: jobTitleController,hintText: 'eg: Software Developer',),
                        ],
                      ),
                    )
                  ],
                ...
                Column(
                  ...
                  children: [
                    ...
                    CustomTextField(controller: skillSetController, hintText: 'eg: Java, Python etc.')
                  ],
                ),
                SizedBox(height: Sizes.responsiveMd(context),),
                Column(
                      ...
                      child: Row(
                        children: [
                          Padding(
                            ...
                            child: Expanded(child: Icon(Icons.calendar_month_sharp,size: 14,color: AppColors.secondaryText,)),
                          ),
                          const Expanded
                            (flex:  1,

                              child: VerticalDivider(thickness: 1.0,width: 0.37,color: AppColors.black,)),
                      Expanded(flex:  10,
                        child: TextField(
